...
export const GEETHAMS = [
    ...
    { id: 'g-analekara', title: 'Analekara', compositionType: 'Geetham', raga: 'Shuddha Saveri', tala: 'Triputa', composer: 'Traditional', exerciseId: null },
    { id: 'g-kamala', title: 'Kamalajaathala', compositionType: 'Geetham', raga: 'Kalyani', tala: 'Triputa', composer: 'Traditional', exerciseId: null },
    { id: 'g-rere', title: 'Rere Sriramachandra', compositionType: 'Geetham', raga: 'Arabhi', tala: 'Triputa', composer: 'Traditional', exerciseId: null },
    { id: 'g-srirama', title: 'Sri Ramachandra', compositionType: 'Geetham', raga: 'Bhairavi', tala: 'Dhruva Talam', composer: 'Traditional', exerciseId: null },
    { id: 'g-varaveena', title: 'VaraVeena', compositionType: 'Geetham', raga: 'Mohanam', tala: 'Rupakam', composer: 'Traditional', exerciseId: null },
];

// ─── Swarajatis ──────────────────────────────────────────────────────────────
export const SWARAJATIS = [
    { id: 'sw-raara', title: 'Raara Venugopa', compositionType: 'Swarajati', raga: 'Bilahari', tala: 'Adi', composer: 'Traditional', exerciseId: null },
    { id: 'sw-samba', title: 'Samba Shivayanave', compositionType: 'Swarajati', raga: 'Khamas', tala: 'Adi', composer: 'Traditional', exerciseId: null },
];

// ─── Varnams ─────────────────────────────────────────────────────────────────
export const VARNAMS = [
    { id: 'v-viriboni', title: 'Viriboni', compositionType: 'Varnam', raga: 'Bhairavi', tala: 'Ata Talam', composer: 'Pacchimirium Sree Aadiappiyer', exerciseId: null },
    ...
    { id: 'v-entho', title: 'Entho Prema', compositionType: 'Varnam', raga: 'Surutti', tala: 'Adi', composer: 'Pallavi Gopalaiyer', exerciseId: null },
    { id: 'v-era', title: 'Era Napai', compositionType: 'Varnam', raga: 'Thodi', tala: 'Adi', composer: 'Patnam Subramanya Iyer', exerciseId: null },
    { id: 'v-evvari', title: 'Evvari Bodhana', compositionType: 'Varnam', raga: 'Abhogi', tala: 'Adi', composer: 'Patnam Subramania Iyer', exerciseId: null },
    ...
    { id: 'v-intha', title: 'Intha Chalamu', compositionType: 'Varnam', raga: 'Begada', tala: 'Adi', composer: 'Veenai Kuppaiyer', exerciseId: null },
    { id: 'v-jalajakshi', title: 'Jalajakshi', compositionType: 'Varnam', raga: 'Hamsadhwani', tala: 'Adi', composer: 'Manmbuchavadi Venkatasubbaiyer', exerciseId: null },
    { id: 'v-ninnukori-m', title: 'Ninnukori', compositionType: 'Varnam', raga: 'Mohanam', tala: 'Adi', composer: 'R.S. Iyengar', exerciseId: null },
    ...
    { id: 'v-sami-k', title: 'Sami Dayajuda', compositionType: 'Varnam', raga: 'Kedaragowla', tala: 'Adi', composer: 'Tiruvottriyur Thiagayyer', exerciseId: null },
    { id: 'v-sami-sh', title: 'Sami Ninne', compositionType: 'Varnam', raga: 'Shankarabharanam', tala: 'Adi', composer: 'Veenai Kuppayier', exerciseId: null },
    ...
    { id: 'v-vanajaksha-r', title: 'Vanajaksha', compositionType: 'Varnam', raga: 'Reethigowlai', tala: 'Ata Talam', composer: 'Veenai Kuppaiyer', exerciseId: null },
    ...
    { id: 'v-inthamod', title: 'Intha Modi', compositionType: 'Varnam', raga: 'Saaranga', tala: 'Adi', composer: 'Tiruvotriyur Thyagaiyer', exerciseId: null },
    { id: 'v-karunimpa', title: 'Karunimpa', compositionType: 'Varnam', raga: 'Sahana', tala: 'Adi', composer: 'Tiruvotriyur Thiyagaiyer', exerciseId: null },
];
...
export const KRITHIS = [
    ...
    { id: 'k-alai', title: 'Alai Payudhe', compositionType: 'Kriti', raga: 'Kanada', tala: 'Adi', composer: 'OothukaDu Venkata Subbaiyer', exerciseId: null },
